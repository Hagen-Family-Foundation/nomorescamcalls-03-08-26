...
export const TrustBadges = () => {
  ...
  return (
    <section className="py-16 bg-gray-50 border-y border-gray-200" data-testid="trust-badges-section">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 items-center">
          ...
          <div className="flex flex-col items-center text-center">
            <div className="w-24 h-24 bg-white rounded-lg shadow-sm flex items-center justify-center mb-3 border border-gray-200">
              <div className="text-center">
                <Award className="h-10 w-10 text-blue-600 mx-auto mb-1" />
          ...
          <div className="flex flex-col items-center text-center">
            <div className="w-24 h-24 bg-white rounded-lg shadow-sm flex items-center justify-center mb-3 border border-gray-200">
              <div className="text-center">
                <Shield className="h-10 w-10 text-purple-600 mx-auto mb-1" />
                <div className="text-xs font-bold text-purple-600">SOC 2</div>
              </div>
            </div>
          ...
          <div className="flex flex-col items-center text-center">
            <div className="w-24 h-24 bg-white rounded-lg shadow-sm flex items-center justify-center mb-3 border border-gray-200">
              <div className="text-center">
                <CheckCircle className="h-10 w-10 text-blue-600 mx-auto mb-1" />
                <div className="text-xs font-bold text-blue-600">GDPR</div>
              </div>
            </div>
          ...
          <div className="flex flex-col items-center text-center">
            <div className="w-24 h-24 bg-white rounded-lg shadow-sm flex items-center justify-center mb-3 border border-gray-200">
              <div className="text-center">
                <Star className="h-10 w-10 text-green-600 mx-auto mb-1 fill-green-600" />
